...
def test_calculate_footprint_zero_transport():
    inputs = UserInputs(transport_miles_per_week=0, mpg=20, electricity_kwh_per_month=0, diet_type="vegan")
...
def test_calculate_footprint_normal():
    inputs = UserInputs(transport_miles_per_week=100, mpg=25, electricity_kwh_per_month=500, diet_type="omnivore")
    res = calculate_footprint(inputs)
...
def test_calculate_footprint_invalid_diet():
    inputs = UserInputs(transport_miles_per_week=0, mpg=20, electricity_kwh_per_month=0, diet_type="unknown")
    res = calculate_footprint(inputs)
